...
namespace GameFoundation.BlueprintFlow.BlueprintReader.CsvHelper
{
    ...
    using GameFoundation.BlueprintFlow.BlueprintReader.CsvHelper.TypeConversion;
    ...
    public class TypeConverterCache
    {
        ...
        {
            foreach (var type in this.typeConverters.Keys)
            {
                this.typeConverters[type] = typeConverter;
            }
        }
        ...
        public ITypeConverter GetConverter(Type type)
        {
            ...
            if (this.typeConverters.TryGetValue(type, out ITypeConverter typeConverter))
            {
