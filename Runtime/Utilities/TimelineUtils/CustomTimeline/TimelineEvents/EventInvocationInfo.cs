namespace GameFoundation.Utilities.TimelineUtils.CustomTimeline.TimelineEvents {
    using System;
    using System.Linq;
    ...
    public class EventInvocationInfo {
        ...
        public void Invoke(object value) {
            if (this.MethodInfo != null) {
                this.MethodInfo.Invoke(this.TargetBehaviour, new[] {value});
            }
        }
        ...
        public void InvokEnum(int value) {
            ...
            if (this.MethodInfo != null) {
                this.MethodInfo.Invoke(this.TargetBehaviour, new[] {enumValue});
            }
        }
                ...
                if (isSingleArg) {
                    ...
                    if (paramType.IsEnum) {
                        ...
                        if (paramType == typeof(string)) {
                            ...
                            Debug.Log(
                                "Could not parse argument value " + value + " for method " + this.MethodInfo.Name +
                                ". Ignoring");
                        }
                    }
                    else {
                        Debug.Log("Could not parse argument value " + value + " for method " + this.MethodInfo.Name +
                                  ". Ignoring");
                    }
                }
                else {
        ...
        public static bool IsValidAsType(string input, Type type) {
            ...
            if (type == typeof(string)) {
                ...
                isConverted = bool.TryParse(input, out _);
            }
