namespace GameFoundation.Network.WebService
{
    ...
    public interface IHttpService
    {
        ...
        UniTask SendAsync<T, TK>(IHttpRequestData httpRequestData = null) where T : BaseHttpRequest, IDisposable where TK : IHttpResponseData;
    ...
    public abstract class BaseHttpRequest<T> : BaseHttpRequest, IDisposable, IPoolable<IMemoryPool> where T : IHttpResponseData
    {
